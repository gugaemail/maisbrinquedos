...
export default async function BannersPage() {
  ...
  return (
    <div className="p-8 space-y-12">
      {/* Hero banners */}
      <section>
        <h1 className="text-2xl font-display font-extrabold text-[#0F0F0F] mb-2">Banners principais</h1>
      ...
      {/* Promo banner */}
      <section>
        <h2 className="text-xl font-display font-extrabold text-[#0F0F0F] mb-2">Banner de promoção</h2>
