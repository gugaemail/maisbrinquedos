...
export default async function BannersPage() {
  ...
  return (
    <div className="p-8 space-y-12">
      {/* Hero banners */}
      <section>
        <h1 className="text-2xl font-display font-extrabold text-[#1A1A2E] mb-2">Banners principais</h1>
        <p className="text-sm text-[#6B7080] font-body mb-6">Carrossel exibido no topo da loja quando há banners ativos.</p>
        <BannersList initialBanners={banners} />
      </section>

      {/* Promo banner */}
      <section>
        <h2 className="text-xl font-display font-extrabold text-[#1A1A2E] mb-2">Banner de promoção</h2>
        <p className="text-sm text-[#6B7080] font-body mb-6">Faixa amarela exibida entre as categorias e os produtos em destaque.</p>
